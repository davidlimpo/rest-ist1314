...
public class ChequeRefeicaoLocal extends ChequeRefeicao{
	...
	@Override
	public void pagarComCheque(List<String> checks, Cliente c, ChequeRefeicao cheque) throws InvalidCheckException, CheckAlreadyUsedException {
		
		int valor = cheque.cashChecks(c.getNome(), checks);
		c.somaSaldo(valor);
